...
| <a name="input_streamx_operator_default_gateway_certificate_ref"></a> [streamx\_operator\_default\_gateway\_certificate\_ref](#input\_streamx\_operator\_default\_gateway\_certificate\_ref) | n/a | `string` | `null` | no |
| <a name="input_streamx_operator_default_gateway_class_name"></a> [streamx\_operator\_default\_gateway\_class\_name](#input\_streamx\_operator\_default\_gateway\_class\_name) | n/a | `string` | `null` | no |
| <a name="input_streamx_operator_default_gateway_domain"></a> [streamx\_operator\_default\_gateway\_domain](#input\_streamx\_operator\_default\_gateway\_domain) | n/a | `string` | `null` | no |
