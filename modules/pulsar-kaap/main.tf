locals {
  ...
  chart_name       = var.chart_name != null ? var.chart_name : "kaap"
  chart_repository = var.chart_repository != null ? var.chart_repository : "https://datastax.github.io/kaap"
  chart_version    = var.chart_version != null ? var.chart_version : "0.2.1"
  ...
  namespace        = var.namespace != null ? var.namespace : "kaap"
  release_name     = var.release_name != null ? var.release_name : "kaap"
