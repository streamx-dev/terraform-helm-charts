locals {
  default_atomic           = true
  default_chart_name       = "base"
  default_chart_repository = "https://istio-release.storage.googleapis.com/charts"
  default_chart_version    = "1.28.0"
  default_cleanup_on_fail  = true
  default_create_namespace = true
  default_namespace        = "istio-system"
  default_release_name     = "istio-base"
  default_settings         = {}
  default_timeout          = 300
  default_values           = []
