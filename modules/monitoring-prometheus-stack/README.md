...
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | The version of the Helm chart to install | `string` | `"69.2.3"` | no |
...
| <a name="input_release_name"></a> [release\_name](#input\_release\_name) | The name of the helm release | `string` | `"prometheus-stack"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_metrics_otlp_endpoint"></a> [metrics\_otlp\_endpoint](#output\_metrics\_otlp\_endpoint) | OTLP endpoint |
<!-- END_TF_DOCS -->