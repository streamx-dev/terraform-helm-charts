locals {
  default_atomic           = true
  default_chart_name       = "kiali-operator"
  default_chart_repository = "https://kiali.org/helm-charts"
  default_chart_version    = "2.13"
  default_cleanup_on_fail  = true
  default_create_namespace = true
  default_namespace        = "kiali-operator"
  default_release_name     = "kiali-operator"
  default_settings         = {}
  default_timeout          = 300
  default_values           = []
