locals {
  default_atomic           = true
  default_chart_name       = "capsule"
  default_chart_repository = "https://projectcapsule.github.io/charts"
  default_chart_version    = "0.11.1"
  default_cleanup_on_fail  = true
  default_create_namespace = true
  default_namespace        = "capsule"
  default_release_name     = "capsule"
  default_settings         = {}
  default_timeout          = 300
  default_values           = []
