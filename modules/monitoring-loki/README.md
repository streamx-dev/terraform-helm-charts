...
| <a name="input_chart_name"></a> [chart\_name](#input\_chart\_name) | The name of the Helm chart to install | `string` | `"loki"` | no |
...
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | The version of the Helm chart to install | `string` | `"6.27.0"` | no |
...
| <a name="input_namespace"></a> [namespace](#input\_namespace) | The namespace used for the deployment | `string` | `"loki"` | no |
| <a name="input_release_name"></a> [release\_name](#input\_release\_name) | The name of the helm release | `string` | `"loki"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_loki_otlp_endpoint"></a> [loki\_otlp\_endpoint](#output\_loki\_otlp\_endpoint) | Loki service OTLP endpoint |
<!-- END_TF_DOCS -->