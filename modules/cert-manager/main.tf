locals {
  ...
  chart_name       = var.chart_name != null ? var.chart_name : "cert-manager"
  chart_repository = var.chart_repository != null ? var.chart_repository : "https://charts.jetstack.io"
  chart_version    = var.chart_version != null ? var.chart_version : "v1.14.5"
  ...
  release_name     = var.release_name != null ? var.release_name : "cert-manager"
